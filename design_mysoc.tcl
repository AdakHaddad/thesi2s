...
################################################################
# This is a generated script based on design: design_mysoc
#
...
# source design_mysoc_script.tcl
...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net axi_smc_M02_AXI [get_bd_intf_pins axi_smc/M02_AXI] [get_bd_intf_pins axi_7segment_0/S00_AXI]
  ...
  # Create port connections
  connect_bd_net -net axi_7segment_0_an  [get_bd_pins axi_7segment_0/an] \
  [get_bd_ports an_0]
  connect_bd_net -net axi_7segment_0_dp  [get_bd_pins axi_7segment_0/dp] \
  [get_bd_ports dp_0]
  connect_bd_net -net axi_7segment_0_seg  [get_bd_pins axi_7segment_0/seg] \
  [get_bd_ports seg_0]
  ...
  [get_bd_pins axi_7segment_0/s00_axi_aclk]
