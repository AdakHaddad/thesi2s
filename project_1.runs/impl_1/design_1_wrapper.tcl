namespace eval ::optrace {
  variable script "C:/fixi2s/freshi2s/project_1.runs/impl_1/design_1_wrapper.tcl"
...
set rc [catch {
  ...
  set_param synth.incrementalSynthesisCache C:/Users/LENOVO/Documents/.Xil/Vivado-13112-DESKTOP-HTVV1N1/incrSyn
...
OPTRACE "set parameters" START { }
  set_property webtalk.parent_dir C:/fixi2s/freshi2s/project_1.cache/wt [current_project]
  set_property parent.project_path C:/fixi2s/freshi2s/project_1.xpr [current_project]
  set_property ip_repo_paths C:/fixi2s/freshi2s/ip_repo [current_project]
  update_ip_catalog
  set_property ip_output_repo C:/fixi2s/freshi2s/project_1.cache/ip [current_project]
  set_property ip_cache_permissions {read write} [current_project]
  set_property XPM_LIBRARIES {XPM_CDC XPM_FIFO XPM_MEMORY} [current_project]
OPTRACE "set parameters" END { }
OPTRACE "add files" START { }
  add_files -quiet C:/fixi2s/freshi2s/project_1.runs/synth_1/design_1_wrapper.dcp
  set_msg_config -source 4 -id {BD 41-1661} -limit 0
  set_param project.isImplRun true
  add_files C:/fixi2s/freshi2s/project_1.srcs/sources_1/bd/design_1/design_1.bd
  set_param project.isImplRun false
OPTRACE "read constraints: implementation" START { }
  read_xdc C:/fixi2s/freshi2s/project_1.srcs/constrs_1/new/cnstrn.xdc
