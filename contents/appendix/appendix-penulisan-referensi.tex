...
Penulisan referensi mengikuti aturan standar yang sudah ditentukan. Untuk internasionalisasi DTETI, penulisan referensi akan mengikuti standar yang ditetapkan oleh IEEE (\textit{Institute of Electrical and Electronics Engineers}). Aturan penulisan ini bisa diunduh di \textcolor{blue}{http://www.ieee.org/documents/ieeecitationref.pdf}. Gunakan Mendeley sebagai \textit{reference manager} dan ekspor data ke format BibTeX untuk digunakan di LaTeX.
