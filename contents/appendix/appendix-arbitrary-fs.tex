...
\begin{lstlisting}[language=Verilog, caption={Akumulator fase DDS untuk pembangkitan BCLK pada \path{i2s\_dds\_slave\_lite\_v1\_0\_S00\_AXI.v}.}, label={lst:app-dds-bclk}]
