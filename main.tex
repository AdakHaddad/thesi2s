...
\title{Perancangan Peripheral I2S dengan AXI4-Lite Interface menggunakan Verilog}
% Program and the head of the program
\program{Teknik Elektro}{<<Koordinator Program Studi>>}{<<NIP>>}
% Name of department head and NIP
\departmenthead{<<Kepala Departemen DTETI>>}{<<NIP>>}
\major{Teknik Elektro dan Teknologi Informasi}
\yearsubmit{<<TAHUN PENDADARAN>>}
\examdate{<<Tanggal Ujian>>}
% Name of thesis supervisors/promotors
\addsupervisor{<<Dosen Pembimbing 1, S.T., M.Eng., Ph.D.>>}{<<NIP xxxxxx>>}
\addsupervisor{<<Dosen Pembimbing 2, S.T., M.Eng., Ph.D.>>}{<<NIP xxxxxx>>}
...
% Bab VI tidak digunakan; skripsi ini terdiri dari Bab I–V.
%\cleardoublepage \phantomsection
...
\chapterappendixadd{contents/appendix/appendix-panduan-gambar}
