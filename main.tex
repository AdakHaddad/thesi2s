...
\begin{center}
	\textcolor{red}{
	Catatan: Naskah ini telah direvisi menjadi fokus I2S-only. Berkas \texttt{references.bib} bawaan template belum diselaraskan dengan sitasi final, sehingga daftar pustaka otomatis dinonaktifkan sementara. Tambahkan kembali sitasi I2S/AXI/MicroBlaze yang valid sebelum versi akhir skripsi.}
\end{center}
