...
# module references:
# filter_coeff, i2s_filter_bridge
...
proc create_root_design { parentCell } {
  ...
  set filter_sw [ create_bd_port -dir I -from 2 -to 0 filter_sw ]
  ...
  set i2s_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:i2s:1.0 i2s_0 ]

  # Create instance: filter_coeff_0, and set properties
  set block_name filter_coeff
  set block_cell_name filter_coeff_0
  if { [catch {set filter_coeff_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $filter_coeff_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  
  # Create instance: i2s_filter_bridge_0, and set properties
  set block_name i2s_filter_bridge
  set block_cell_name i2s_filter_bridge_0
  if { [catch {set i2s_filter_bridge_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $i2s_filter_bridge_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  connect_bd_intf_net -intf_net axi_smc_M01_AXI [get_bd_intf_pins axi_smc/M01_AXI] [get_bd_intf_pins i2s_0/S00_AXI]
  ...
  connect_bd_net -net filter_coeff_0_y_out1  [get_bd_pins filter_coeff_0/y_out] \
  [get_bd_pins i2s_filter_bridge_0/left_filtered] \
  [get_bd_pins i2s_filter_bridge_0/right_filtered]
  connect_bd_net -net filter_sw_1  [get_bd_ports filter_sw] \
  [get_bd_pins i2s_filter_bridge_0/filter_sw_in]
  connect_bd_net -net i2s_0_i2s_bclk  [get_bd_pins i2s_filter_bridge_0/i2s_bclk_out] \
  [get_bd_ports i2s_bclk_0]
  connect_bd_net -net i2s_0_i2s_bclk2  [get_bd_pins i2s_0/i2s_bclk] \
  [get_bd_pins i2s_filter_bridge_0/i2s_bclk_in]
  connect_bd_net -net i2s_0_i2s_data  [get_bd_pins i2s_filter_bridge_0/i2s_data_out] \
  [get_bd_ports i2s_data_0]
  connect_bd_net -net i2s_0_i2s_data2  [get_bd_pins i2s_0/i2s_data] \
  [get_bd_pins i2s_filter_bridge_0/i2s_data_in]
  connect_bd_net -net i2s_0_i2s_mclk  [get_bd_pins i2s_filter_bridge_0/i2s_mclk_out] \
  [get_bd_ports i2s_mclk_0]
  connect_bd_net -net i2s_0_i2s_mclk2  [get_bd_pins i2s_0/i2s_mclk] \
  [get_bd_pins i2s_filter_bridge_0/i2s_mclk_in]
  connect_bd_net -net i2s_0_i2s_ws  [get_bd_pins i2s_filter_bridge_0/i2s_ws_out] \
  [get_bd_ports i2s_ws_0]
  connect_bd_net -net i2s_0_i2s_ws2  [get_bd_pins i2s_0/i2s_ws] \
  [get_bd_pins i2s_filter_bridge_0/i2s_ws_in]
  connect_bd_net -net i2s_filter_bridge_0_filter_sw_out1  [get_bd_pins i2s_filter_bridge_0/filter_sw_out] \
  [get_bd_pins filter_coeff_0/sw]
  connect_bd_net -net i2s_filter_bridge_0_left_sample1  [get_bd_pins i2s_filter_bridge_0/left_sample] \
  [get_bd_pins filter_coeff_0/x_in]
  connect_bd_net -net i2s_filter_bridge_0_left_valid1  [get_bd_pins i2s_filter_bridge_0/left_valid] \
  ...
  assign_bd_address -offset 0x44A00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces microblaze_riscv_0/Data] [get_bd_addr_segs i2s_0/S00_AXI/S00_AXI_reg] -force
