    ...
    \column{0.5\textwidth}
      ...
      \begin{enumerate}\small
        ...
        \item Bagaimana memverifikasi fungsionalitas dan timing
              melalui simulasi dan uji audio PCM5102A?
      \end{enumerate}
    \column{0.5\textwidth}
  ...
  \begin{columns}[T]
    \column{0.50\textwidth}
      ...
      \begin{enumerate}\small
        ...
        \item \textbf{Seleksi clock internal} -- pilih \texttt{audio\_48\_clk} atau \texttt{audio\_44\_clk}.
...
\begin{frame}{Hasil Verifikasi -- Osiloskop dan Waveform}
  \begin{columns}[T]
    \column{0.50\textwidth}
    ...
    \column{0.50\textwidth}
      \IfFileExists{contents/figures/sample-latching-leftright-waveform.png}{%
        \includegraphics[width=\linewidth]{contents/figures/sample-latching-leftright-waveform.png}%
      }{}
  \end{columns}
\end{frame}
...
\begin{frame}{Kesimpulan}
  \begin{enumerate}
    ...
    \item \textbf{Timing I2S} terverifikasi via osiloskop: 64 BCLK/frame, delay-bit
...
\begin{frame}{Saran Pengembangan}
  \begin{enumerate}
    ...
    \item Menambahkan diagnostik underrun berbasis FIFO/interrupt
