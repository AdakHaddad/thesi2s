    ...
    \column{0.45\textwidth}
      \IfFileExists{contents/figures/diagram-sinyal-i2s-philips.pdf}{%
        ...
        \fbox{\parbox{0.95\linewidth}{\centering\scriptsize
          [PLACEHOLDER]\\Diagram timing I2S:\\BCLK / WS / DATA\\satu frame stereo}}%
      }
  \end{columns}
\end{frame}
  ...
  \begin{columns}[T]
    ...
    \column{0.50\textwidth}
      \IfFileExists{contents/figures/block-design-vivado-i2s-screenshot.png}{%
        ...
        \fbox{\parbox{0.95\linewidth}{\centering\scriptsize
          [PLACEHOLDER]\\Screenshot Vivado Block Design:\\MicroBlaze V → AXI SmartConnect\\→ IP I2S → PMOD JA}}%
      }
  \end{columns}
\end{frame}
  ...
  \begin{columns}[T]
    ...
    \column{0.50\textwidth}
      \IfFileExists{contents/figures/block-diagram-ip-i2s-tx-intern.pdf}{%
        ...
        \fbox{\parbox{0.95\linewidth}{\centering\scriptsize
          [PLACEHOLDER]\\Blok diagram internal:\\AXI Regs → CDC → BUFGMUX\\→ Clock Div → Serializer → DATA}}%
      }
  \end{columns}
\end{frame}
  ...
  \begin{columns}[T]
    ...
    \column{0.50\textwidth}
      \IfFileExists{contents/figures/wiring-pcm5102a-basys3.jpg}{%
        \includegraphics[width=\linewidth]{contents/figures/wiring-pcm5102a-basys3.jpg}%
      }{%
        \fbox{\parbox{0.95\linewidth}{\centering\scriptsize
          [PLACEHOLDER]\\Foto wiring:\\Basys3 PMOD JA → PCM5102A}}%
      }
  \end{columns}
\end{frame}
  ...
  \begin{columns}[T]
    ...
    \column{0.50\textwidth}
      \IfFileExists{contents/figures/ila-bclk-ws-data.png}{%
        ...
        \fbox{\parbox{0.95\linewidth}{\centering\scriptsize
          [PLACEHOLDER]\\Tangkapan ILA:\\BCLK / WS / DATA\\(trigger: tepi turun WS)}}%
      }
  \end{columns}
\end{frame}
  ...
  \begin{columns}[T]
    ...
    \column{0.50\textwidth}
      \IfFileExists{contents/figures/scope-sine-both-ch-fixed.png}{%
        ...
        \fbox{\parbox{0.95\linewidth}{\centering\scriptsize
          [PLACEHOLDER]\\Osiloskop/Audacity setelah fix:\\kanal L = R, amplitudo identik}}%
      }
  \end{columns}
\end{frame}
