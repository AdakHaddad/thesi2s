...
HD_PWD='D:/Vivado-projects/Basys3/sbml/microblazev_tutorial/microblazev_tutorial.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log design_mysoc_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source design_mysoc_wrapper.tcl -notrace
