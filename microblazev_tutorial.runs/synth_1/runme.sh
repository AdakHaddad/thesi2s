...
HD_PWD='D:/Vivado-projects/Basys3/sbml/microblazev_tutorial/microblazev_tutorial.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_mysoc_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_mysoc_wrapper.tcl
