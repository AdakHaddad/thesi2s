...
HD_PWD='D:/Vivado-projects/Basys3/sbml/microblazev_tutorial/microblazev_tutorial.runs/design_mysoc_lmb_bram_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_mysoc_lmb_bram_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_mysoc_lmb_bram_0.tcl
